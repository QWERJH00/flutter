void main()
{
  ...
  */
  Map<String, int> map2 = Map();  // new 생략가능
  map2['홍길동'] = 20;
  map2['전우치'] = 25;
  map2['손오공'] = 30;
  print(map2);

  map2['멀린'] = 35;  // 추가(기존의 key값이 없기 때문)
