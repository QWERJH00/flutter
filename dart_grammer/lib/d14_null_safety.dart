void main()
{
  ...
  // num3 = num4;  // 컴파일 전 체크
  // num3 = num4!; // 실행 시 체크 (null체크 하라는 의미. 에러는 아님)
  //print(num4);
  ...
  // Null 일 때
  // n42는 정수가 아니므로 정수 변환시 에러가 발생됨. 따라서 val2는 -1로 초기화 된다.
  ...
  print('val2 = $val2');
    ...
    // String text = name1;
    // 이렇게 에러가 떴을 때는 어떻게 해야하나? 변수 뒤에 '!'를 붙히거나 (이걸 많이씀)
    // String옆에 ? 붙히자. 그러면 플러터는 '아 저 변수는 사용되는 시점에서 null값이
    // 절대 아니구나' 하고 에러를 없애준다.
    String text = name1!;
    print(text);
  }
