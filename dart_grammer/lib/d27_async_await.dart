...
// async, await는 pair : await는 async내부에서만 사용 가능
...
void main() async{    // async를 제거하면 아래에서 에러가 발생.
  // 비동기를 위한 async와 await는 반드시 같이 사용되야한다.
  print('main 시작01');
  myRequest1();
  print('main 끝01');
  ...
  print('main 시작02');
  /*
    Future와 then절을 함께 사용하거나(방법1) async와 await을 사용해야한다.(방법2)
  */
