void main()
{
  ...
  // 실패시 Exception : 예외가 발생하면 그 즉시 프로그램의 실행이 중지.
  ...
  // 실패시 null tryParse에 try ~ on이 들어가있음. 그래서 예외가 생기면 null
  ...
  // 여기서 int ? 가 없는 이유 val1값에 -1이 들어오므로 null이 들어올 수 없다.
  print('val1 = $val1');  // 예외가 발생하므로 -1이 할당된다.
  // var는 어떤 값이라도 들어올 수 있다. 즉 null도 들어올 수 있다는 것이므로
  // ?를 안써도된다.
  var val2 = int.tryParse('m42');
  print('val2 = $val2'); // 예외가 발생하므로 null이 할당된다.
