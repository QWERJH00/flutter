        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              color: Colors.yellow, // 지정하지 않으면 컨테이너의 크기를 알 수 없음.
              // width: 300,  // 크기를 지정하지 않으면 부모의 크기 (네이버 가로 세로 생각하자)
              height: 100,    // 크기를 지정하지 않으면 자식의 크기 (네이버 가로 세로 생각하자)
            ...
            Container(
              ...
              decoration: const BoxDecoration(  // 상태차 ㅇ꾸미기
                image: DecorationImage(
                  image: AssetImage('assets/images/300x100.png')
                ),
              ),
              // 텍스트 버튼으로 마치 이미지 버튼과 같은 효과를 적용.
              child: TextButton(
                child: const Text('',),
