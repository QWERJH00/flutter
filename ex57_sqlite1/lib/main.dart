...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void doSelectAll() async {
    ...
    // select한 결과는 List로 반환
    List<Map> datas = await db.rawQuery('select * from telbook');
    /*
      컬렉션에 어떤 것이 포함되어 있는지 확인하기 위해서 호출 length
      하는 것은 매우 느릴 수 있다. 대신 더 빠르고 더 읽기 쉬운 게터가
      있다.
      isEmpty및 isNptEmpty. 결과를 부정할 필요가 없는 것을 사용하자.  
    */
